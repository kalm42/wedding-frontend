  ...
  return (
    <Layout>
      ...
      <TwoColumns>
        ...
        <div>
          <p>
            ...
            House is truly a wonder of architecture and hospitality. As our guest, you’re invited to
            enjoy a self-guided tour of the house, as well as the beautiful gardens and grounds
      ...
      <TwoColumns>
        ...
        <div>
          <p>
            ...
            Carolina Arboretum offers acres of cultivated gardens and groomed trails featuring some
            of the most beautiful, botanically-diverse plants in the region. Open 8AM – 9PM.
          </p>
          <p>
      ...
      <TwoColumns>
        ...
        <div>
          <p>
            ...
            collaboration of spectacular views and incredible hiking trails. They combine to create
            a mountain adventure experience that is postcard perfect. We do not consider any of our
            trails to be wheelchair or stroller accessible, and we recommend carrying small children
            who cannot hike the trails in packs.
          </p>
          <p>
      ...
      <TwoColumns>
        ...
        <div>
          <p>
            Comedy tour options through downtown Asheville. Book in advance! 4 options – City comedy
            Tour, the Haunted Comedy Tour, the Band &amp; Beer Tour and the Kids’ Comedy Tour.
          </p>
          <p>
            Shelly, and I went on this with Shelly&amp;s parents, specifically the beer tour. It was
            a great time, almost ended with Shelly getting a sister-wife. Make sure to ask Shelly
            about that.
          </p>
          <p>
